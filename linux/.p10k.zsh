# Generated by Powerlevel10k configuration wizard on 2026-02-05 at 12:31 CET.
...
() {
  ...
  ################################[ prompt_char: prompt symbol ]################################
  # Green prompt symbol if the last command succeeded. old=76
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%51F'   # green foreground old=76
