# Generated by Powerlevel10k configuration wizard on 2025-12-20 at 13:15 CET.
...
() {
  ...
  ################################[ prompt_char: prompt symbol ]################################
  # Green prompt symbol if the last command succeeded. 76 old
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%245F'   # green foreground
      local   modified='%178F'  # yellow foreground
      local  untracked='%39F'   # blue foreground
      local 	  cyan='%6F'  # cyan foreground
      ...
      local 	  cyan='%244F'  # cyan foreground
    ...
    if (( VCS_STATUS_COMMITS_AHEAD || VCS_STATUS_COMMITS_BEHIND )); then
      ...
      (( VCS_STATUS_COMMITS_BEHIND )) && res+=" ${cyan}⇣${VCS_STATUS_COMMITS_BEHIND}"
